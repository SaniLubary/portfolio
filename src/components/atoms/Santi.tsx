...
export default function Model({ ...props }: ModelType) {
  ...
  const { nodes, materials } = useGLTF("assets/santi2.glb") as GLTFResult;

  return (
    <group ref={group} {...props} dispose={null}>
      {props.bbanchor && <BBAnchor anchor={[-.92, .5, 0]}>
        <Html>
          <div style={{
            width: 'fit-content',
            whiteSpace: 'nowrap',
            boxShadow: '0px 0px 10px 2px #0ff',
            borderRadius: '5px',
            padding: '5px 10px',
            userSelect: 'none',
            color: "white",
...
useGLTF.preload("assets/santi2.glb");
