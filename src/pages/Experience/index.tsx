  ...
  return (
    <div className="show body">
      ...
      <div className="grid custom-grid-template-cols-left grid-cols-3">
        <div className="poppins nav--trigger-scroll-start dissapearLeft flex flex-col items-start col-start-1 col-end-4 text-4xl mb-20 2xl:ml-28 xl:ml-20 md:ml-12 sm:ml-0 2xl:w-1/4 xl:w-1/3 sm:w-1/2">
          Equipos de los que forme parte!
        </div>

        <div className='dissapearLeft flex flex-col justify-center items-center'>
          <div className="top-dotted-line h-16"></div>
        </div>
        <div className='dissapearLeft col-start-2 col-end-4'></div>

        <TimelineIcon rightSide={false} text='Andes' />
        <ExperienceDetails
          detail={<>
          ...
          </>} code={""} visit={""} rightSide={false} />
        <ExperienceSlider rightSide={true}>
        ...
        <TimelineIcon rightSide={false} text='Muni NQN' />
        <ExperienceDetails
          detail={<>
        ...
        <TimelineIcon rightSide={false} text='ADUS / IPVU' />
        <ExperienceDetails
          detail={<>
      ...
      <div className="grid mb-36 mt-36 custom-grid-template-cols-right grid-cols-3">
        ...
        <div className="dissapearRight flex flex-col justify-end items-end col-start-1 col-end-4 text-4xl mb-20 2xl:mr-20 xl:mr-16 md:mr-4 sm:mr-0">
          <div className='poppins 2xl:w-1/4 xl:w-1/3 sm:w-1/2 text-right'>Projectos Personales!</div>
        </div>

        <div className='dissapearRight col-start-1 col-end-3'></div>
        <div className='dissapearRight flex flex-col justify-center items-center'>
          <div className="top-dotted-line h-16"></div>
        </div>
        ...
        <TimelineIcon rightSide={true} text='Este Portfolio!' />
        ...
        <TimelineIcon rightSide={true} text='Typesu!' />
        ...
        <TimelineIcon rightSide={true} text='CSV To Template' />
